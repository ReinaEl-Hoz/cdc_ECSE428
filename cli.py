...
def print_welcome_message():
    ...
    print("  ABS              - Magnitude |z| of top stack value")
    print("  SQR              - Square of top stack value")
    print("  SQRT             - Square root of top stack value")
    print("  SIN              - Sine of top stack value")
    print("  COS              - Cosine of top stack value")
    print("  ASIN             - Inverse sine of top stack value")
    print("  ACOS             - Inverse cosine of top stack value\n")
